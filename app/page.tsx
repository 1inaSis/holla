            ...
            <main className="py-10 mx-auto max-w-7xl">
              <section className="grid grid-cols-12 gap-4 bg-sky-300 "> 
                  <div className="col-span-3 bg-red-300 rounded-xl">
                    <h1 className="text-4xl font-bold text-center">ENACTUSn FSBM</h1>
              ...
              <section className="grid grid-cols-12 gap-4 py-4 bg-sky-300"> 
                  <div className="col-span-3 bg-red-300 rounded-xl p-7 bg-gradient-to-r from-yellow-300 via-yellow-200 to-yellow-100 bg-[length:200%_200%] animate-gradient-flow sticky top-0 z-50 shadow-lg">
                    <h1 className="pb-3 text-xl font-bold text-left text-center">Marketing de Contenu</h1>
                    <p className="text-left text-center text-stone-600 text-balance pb-7">Apprenez à élaborer des campagnes de communication percutantes pour promouvoir vos projets Enactus. Découvrez des outils et techniques modernes pour atteindre votre public cible de manière efficace. </p>
